...
public class Client1 {
    ...
    { 
		...
		try
		{
			...
			FileDownload objServerDownload = new FileDownload(peerServerPort,directoryPath);
			objServerDownload.start();
			
			Socket clientThread = new Socket("localhost",9056);
			...
			socket = new Socket("localhost",9056);
